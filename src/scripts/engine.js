...
async function setCardsField(cardId) {
    ...
    let computerCardId = await getRandomCardId();  //essa é uma roubadinha pro computador, já que ele esta ignorando a mão e usando uma carta nova aleatória.
...
async function ShowHiddenCardFieldsImages(bool) {
    //extract to method
    if(bool){
